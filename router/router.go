...
func SetupRoutes(app *fiber.App) {
	...
	domain.Get("/search",controller.GetSearchedDomains)
	domain.Get("/get-all-domains",controller.GetAllDomains)
	domain.Get("/",middleware.ValidateQueryStrings, controller.GetDomains)
	...
	distributor.Get("/search",controller.GetSearchedDistributors)
	distributor.Get("/get-all-distributors",controller.GetAllDistributors)
	distributor.Get("/",middleware.ValidateQueryStrings,controller.GetDistributors)
	...
	bill.Get("/search",controller.GetSearchedBills)
	bill.Get("/",middleware.ValidateQueryStrings,controller.GetBills)
	...
	product.Get("/search",controller.GetSearchedProduct)
	product.Get("/get-all-products",controller.GetAllProducts)
	product.Get("/",middleware.ValidateQueryStrings,controller.GetProducts)
